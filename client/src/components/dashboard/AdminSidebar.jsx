...
const adminItems = [
  { title: 'Dashboard', url: '/admin', icon: 'chart' },
  { title: 'Verifications', url: '/admin/verify', icon: 'badgeCheck' },
  { title: 'Users', url: '/admin/users', icon: 'user' },
  { title: 'Global Orders', url: '/admin/orders', icon: 'box' },
]
          ...
          <div className="flex items-center justify-between px-4 py-4 border-b border-border">
            {!collapsed ? (
              <div>
                ...
                <p className="font-heading text-lg text-foreground mt-1">Operations</p>
              </div>
            ) : (
              <span className="mx-auto text-primary">
                <IconGlyph name="badgeCheck" size={18} />
              </span>
            )}
